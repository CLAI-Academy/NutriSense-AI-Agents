...
from nutrisense_agents.ai_companion.agents.text_extraction_agent import get_text_extraction_agent_chain
...
def text_extract(state: TextRecipeState) -> Dict[str, Any]:
    """Extrae ingredientes del texto usando análisis de texto"""
    try:
        text_extraction_agent_chain = get_text_extraction_agent_chain()
        result = text_extraction_agent_chain.invoke({"text_description": state["text_description"]})
...
def human_ingredients_validation(state: TextRecipeState) -> Dict[str, Any]:
    """
...
def handle_user_cancellation(state: TextRecipeState) -> Dict[str, Any]:
...
def calc_macros(state: TextRecipeState) -> Dict[str, Any]:
    """
...
def human_consumption_validation(state: TextRecipeState) -> Dict[str, Any]:
    """
...
def insert_food_diary(state: TextRecipeState) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        food_diary_data = {
            ...
            "meal_type": meal_type,
            "recipe_id": None,  # No tenemos receta, es análisis de texto
            ...
            **filtered_macros,
            ...
            "image_url": None  # No hay imagen en análisis de texto
        }
